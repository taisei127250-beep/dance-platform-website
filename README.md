...
- [x] プライバシーポリシーページが公開されている
- [x] 利用規約ページが公開されている
- [x] サポート/お問い合わせページが公開されている
- [ ] 全ページがHTTPSでアクセス可能（デプロイ後）
- [x] モバイルでも正しく表示される

### Stripe審査

- [x] 特定商取引法に基づく表記が公開されている
- [x] 返金ポリシーが明記されている
- [x] 事業者名・代表者名が正確
- [x] 連絡先（Email）が正確
- [x] 商品内容・価格が明確
...
- [x] メタタグ設定（title, description, keywords）
- [x] OGP設定（Facebook/Twitter）
- [ ] OGP画像の作成（1200x630px）`/public/ogp.png`
- [x] robots.txt設定
- [x] sitemap.xml自動生成
- [x] favicon設定
- [x] 404エラーページ
