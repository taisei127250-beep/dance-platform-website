            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg font-mono text-sm">
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-gray-900 dark:text-white">元の参加費:</span>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-500 mt-3">
                  ※ 主催者は、参加費5,000円に加え、既に支払った手数料（プラットフォーム手数料120円 + Stripe決済手数料180円 = 300円）も負担します。
                </p>
              </div>
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-xl mb-6">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 rounded-lg font-mono text-sm">
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      <span className="text-gray-900 dark:text-white">参加費:</span>
                      <span className="text-gray-900 dark:text-white">5,000円</span>
                    </div>
                    ...
                    <div className="flex justify-between font-bold">
                      ...
                      <span className="text-blue-600 dark:text-blue-400">4,600円</span>
                    </div>
                  </div>
                </div>
              </div>
