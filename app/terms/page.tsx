        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                2. 決済に関する情報は、Stripe社のプライバシーポリシーおよび利用規約に基づいて管理されます。
              </p>
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                3. 決済に関するトラブルについて、当サービスは合理的な範囲で対応しますが、最終的な責任は決済サービス提供者が負うものとします。
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                2. ユーザーが当サービスに投稿したコンテンツの著作権は、ユーザーに帰属します。ただし、ユーザーは当サービスに対し、投稿コンテンツを無償で非独占的に使用する権利（サービス運営、プロモーション等の目的）を許諾するものとします。
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                当サービスは、ユーザーへの事前通知なく、サービスの内容を変更、追加、廃止することができるものとします。サービスを終了する場合は、合理的な事前通知を行います。
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                本規約の解釈は日本法に準拠し、当サービスに関する紛争については、東京地方裁判所を第一審の専属的合意管轄裁判所とします。
              </p>
            </section>
